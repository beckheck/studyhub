...
describe('calendar-queries', () => {
  ...
  describe('getItemsOnDate', () => {
    ...
    it('excludes timetable items', () => {
      const timetable = { id: 'tt-1', type: 'timetable', title: 'Lecture', courseId: 'c1', isDeleted: false, createdAt: new Date(), updatedAt: new Date() };
      const date = new Date('2024-01-10T12:00:00.000Z');
    ...
    it('delegates to getItemsInRange (same results for a single date)', () => {
      ...
      const inRange = getItemsInRange([event], new Date('2024-01-10T00:00:00.000Z'), new Date('2024-01-10T23:59:59.999Z'));
