...
export class GoogleCalendarSync {
  ...
  async deleteEvent(eventId: string, accessToken: string, calendarId: string): Promise<GoogleCalendarSyncResult> {
    try {
  ...
  async fetchCalendars(accessToken: string): Promise<Array<{ id: string; summary: string }> | null> {
    try {
  ...
  async fetchEventsFromCalendar(accessToken: string, calendarId: string, timeMin?: Date): Promise<any[]> {
    try {
